  ...
  return (
    <>
      {editFormVisibility===false?(
        <form className='form-group custom-form text-white' onSubmit={handleSubmit} id='form1'>
          <label t>Add your todo-items</label>
          <div className='input-and-btn'>
              <input type="text" id='ip2' className='form-control' required
              value={todoValue} onChange={(e)=>setTodoValue(e.target.value)}/>
              <button type="submit" className='btn btn-primary btn-md todo-button text-white '>ADD</button>
          </div>
        </form>
      ):(
        <form id='f2' className='form-group custom-form' onSubmit={editSubmit}>
          <label>Update your todo-items</label>
          <div className='input-and-btn'>
              <input type="text" id='ip3' className='form-control' required
